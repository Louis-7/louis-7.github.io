      ...
      <div className="flip-avatar-inner">
        ...
        <div className="flip-avatar-back">
          ...
          >
            ...
            <rect x="50" y="25" width="2" height="2" fill="#ffffcc">
              <animate
                attributeName="opacity"
                values="0.5;1;0.5"
                dur="1.5s"
            ...
            <rect x="160" y="20" width="3" height="3" fill="#ffffff">
              <animate
                attributeName="opacity"
                values="0.4;1;0.4"
                dur="2.2s"
            ...
            <rect x="175" y="45" width="2" height="2" fill="#ffffcc">
              <animate
                attributeName="opacity"
                values="0.6;1;0.6"
                dur="1.8s"
            ...
            <rect x="35" y="50" width="2" height="2" fill="#ffffff">
              <animate
                attributeName="opacity"
                values="0.5;1;0.5"
                dur="2.5s"
